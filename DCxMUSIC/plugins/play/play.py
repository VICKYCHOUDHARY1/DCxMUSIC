...
import config
from DCxMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
@app.on_callback_query(filters.regex("DCmousAdmin") & ~BANNED_USERS)
async def DCmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("DCPlaylists") & ~BANNED_USERS)
@languageCB
